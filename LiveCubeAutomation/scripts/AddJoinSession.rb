...
describe "ScenarioTest3" do
  ...
  before(:each) do
   ...
   # @driver.manage.window.maximize
    CreateLog.new().LogStartExecution("execution started of Test Class ScenarioTest1")
  end

    after(:each) do
  CreateLog.new().LogEndExecution("execution end of Test Class ScenarioTest1")
  end
